...
async function resolveViaApi(host) {
 ...
 * ```
 */
export function withTenantResolution(handler) {
    return async function middleware(req) {
        ...
        const editPin = req.nextUrl.searchParams.has("__edit") && req.nextUrl.searchParams.get("client");
 ...
 */
function forwardRequestHeader(res, reqHeaders, name, value) {
